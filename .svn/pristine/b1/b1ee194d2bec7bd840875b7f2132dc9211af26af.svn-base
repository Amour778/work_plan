...
layui.config({
	...
	$("#hideMenu").click(function(){
		...
		if($("#hideMenu").attr('class')=="iconfont hideMenu icon-menu1 layui-icon layui-icon-shrink-right"){
			$("#hideMenu").attr('class',"iconfont hideMenu icon-menu1 layui-icon layui-icon-spread-left")
		}else{
			$("#hideMenu").attr('class',"iconfont hideMenu icon-menu1 layui-icon layui-icon-shrink-right")
		}
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							...
							'<div class="admin-header-lock-name" id="lockUserName">嗯？</div>'+
							'<div class="input_btn">'+
