...
<div id="wcp_bonus_shares_div_vue">
	...
	<div class="layui-card-header">
		...
		<div class="layui-card-body">
			<form class="layui-form" action="" onsubmit="return false" id="table_from">
				<div class="layui-form-item">
					<label class="layui-form-label">预估毛利</label>
					<div class="layui-input-inline">
						<input name="predict_gross_profit" 
							class="layui-input" v-model="predict_gross_profit"
							id="predict_gross_profit"  disabled>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input name="predict_gross_profit" 
							class="layui-input" v-model="predict_gross_profit_per"
							id="predict_gross_profit_per"  disabled>
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">预估净利润</label>
					<div class="layui-input-inline">
						<input type="text" name="predict_net_profit"
							class="layui-input" id="predict_net_profit"
							v-model="predict_net_profit" disabled>
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">预估净利润%</label>
					<div class="layui-input-inline">
						<input name="predict_net_profit_per" v-model="predict_net_profit_per"  class="layui-input"
	...
	<div class="layui-card-header">
		...
		<div class="layui-card-body">
			<form class="layui-form" action="" onsubmit="return false" id="table_from">
				<div class="layui-form-item">
					<label class="layui-form-label">实际毛利</label>
					<div class="layui-input-inline">
						<input name="real_gross_profit" 
							class="layui-input" v-model="real_gross_profit"
							id="real_gross_profit"  disabled>
				...
				<div class="layui-form-item">
					<label class="layui-form-label">实际毛利%</label>
					<div class="layui-input-inline">
						<input name="real_gross_profit_per" 
							class="layui-input" v-model="real_gross_profit_per"
							id="real_gross_profit_per"  disabled>
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">实际净利润</label>
					<div class="layui-input-inline">
						<input name="net_profit" 
							class="layui-input" v-model="net_profit"
							id="net_profit"  disabled>
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">实际净利润%</label>
					<div class="layui-input-inline">
						<input name="net_profit_per" 
							class="layui-input" v-model="net_profit_per"
							id="net_profit_per"  disabled>
					</div>
				</div>
				<shiro:hasAnyRoles name = "ruoa,ruof,ruoh,ruod,ruob">
				 <div class="layui-form-item model-form-footer" id="pending_wcp_actual_expenditure_btn" style="float:right;visibility:hidden">
		...
		function() {
			...
			function(data) {
				if (data.code == 1) {
					...
					vm.real_gross_profit= data.info[0].real_gross_profit?null:0;//实际毛利
					vm.real_gross_profit_per= data.info[0].real_gross_profit_per?null:0;//实际毛利%
					vm.net_profit= data.info[0].net_profit?null:0;//实际净利润
					vm.net_profit_per= data.info[0].net_profit_per?null:0;//实际净利润%
