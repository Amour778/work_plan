				...
				<div class="layui-card-body">
					<form class="layui-form" action="" onsubmit="return false"  lay-filter="formTest">
						<div class="layui-inline" style="margin-top:5px">
							...
							<div class="layui-input-inline disabled" style="margin-top:8px">
						...
						<div class=" layui-inline" style="margin-top:5px">
						    <label class="layui-form-label">是否最后<br/>一次报销</label>
						    <div class="layui-input-inline" style="margin-top:8px">
					...
					<form class="layui-form" action="" onsubmit="return false" id="table_from">
						...
						<div class="layui-inline" id="tax_rate_div" style="margin-top:5px">
							<label class="layui-form-label">
								税率
							</label>
							<div class="layui-input-inline">
						...
						<div class="layui-inline"  v-show="shuie_benjin == '增值税专用发票'" style="margin-top:5px">
							<label class="layui-form-label">
								税额
							</label>
							<div class="layui-input-inline">
						...
						<div class="layui-inline" id="tax_rate_div">
							<label class="layui-form-label">
							</label>
							<div class="layui-input-inline">
