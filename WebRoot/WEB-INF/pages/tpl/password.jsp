...
<div class="layui-card-body" style="padding: 30px;">
    <form class="layui-form" id="form-psw">
        <div class="layui-form-item">
            <input type="password" name="oldPsw" id="pwd_old" required lay-verify="required" class="layui-input"
        ...
        <div class="layui-form-item">
            <input type="password" name="rePsw" id="pwd_new" required lay-verify="required|repsw" class="layui-input"
...
<script>
    layui.use(['form', 'admin', 'layer'], function () {
        ...
        form.on('submit(submit-psw)', function (data) {
            layer.load(2);
            $.post('updataUserPwdWithUserId', 
            {
            pwd_old:hex_sha1($("#pwd_old").val()),
            pwd_new:hex_sha1($("#pwd_new").val())
            }, function (data) {
                if (data.code == 0) {
